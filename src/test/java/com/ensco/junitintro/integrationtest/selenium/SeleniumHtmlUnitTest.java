...
public class SeleniumHtmlUnitTest {
	...
	@Test
	public void testAddUserFormAndLayout() throws InterruptedException {
		driver.get(siteUri.toString());
		...
		assertTrue("Last Name heading: ",
				driver.getPageSource().contains("Last Name"));
		assertTrue("Email heading: ", driver.getPageSource().contains("Email"));
	}
	...
	public void testSearchFuntionality() throws InterruptedException {
		...
		assertFalse("Searching for John",
				driver.getPageSource().contains("John"));
